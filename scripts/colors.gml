...
set_color_profile_slot( 1, 1, 255, 221, 0 ); //RING
set_color_profile_slot( 1, 2, 161, 87, 18 ); //PLANT GANG
set_color_profile_slot( 1, 3, 199, 136, 26 ); //THORN
set_color_profile_slot( 1, 4, 222, 127, 78 ); //WING/EYE (1)
set_color_profile_slot( 1, 5, 173, 54, 54 ); //WING/EYE (2)
set_color_profile_slot( 1, 6, 171, 116, 21 ); //2nd body
set_color_profile_slot( 1, 7, 125, 36, 21 ); //thorn 2

// wilted green
set_color_profile_slot( 2, 0, 84, 179, 55 ); //BODY
set_color_profile_slot( 2, 1, 121, 209, 13 ); //RING
set_color_profile_slot( 2, 2, 99, 81, 34 ); //PLANT GANG
set_color_profile_slot( 2, 3, 110, 138, 23 ); //THORN
set_color_profile_slot( 2, 4, 183, 204, 65 ); //WING/EYE (1)
set_color_profile_slot( 2, 5, 145, 171, 0 ); //WING/EYE (2)
set_color_profile_slot( 2, 6, 0, 125, 20 ); //2nd body
set_color_profile_slot( 2, 7, 97, 39, 0 ); //thorn 2

// bloody red
set_color_profile_slot( 3, 0, 217, 32, 32 ); //BODY
set_color_profile_slot( 3, 1, 240, 120, 60 ); //RING
set_color_profile_slot( 3, 2, 179, 65, 132 ); //PLANT GANG
set_color_profile_slot( 3, 3, 145, 39, 65 ); //THORN
set_color_profile_slot( 3, 4, 186, 39, 121 ); //WING/EYE (1)
set_color_profile_slot( 3, 5, 117, 0, 108 ); //WING/EYE (2)
set_color_profile_slot( 3, 6, 173, 0, 6 ); //2nd body
set_color_profile_slot( 3, 7, 100, 0, 150 ); //thorn 2

// frozen blue
set_color_profile_slot( 4, 0, 105, 224, 199 ); //BODY
set_color_profile_slot( 4, 1, 62, 222, 137 ); //RING
set_color_profile_slot( 4, 2, 43, 153, 65 ); //PLANT GANG
set_color_profile_slot( 4, 3, 0, 89, 79 ); //THORN
set_color_profile_slot( 4, 4, 55, 165, 204 ); //WING/EYE (1)
set_color_profile_slot( 4, 5, 47, 85, 196 ); //WING/EYE (2)
set_color_profile_slot( 4, 6, 81, 148, 131 ); //2nd body
set_color_profile_slot( 4, 7, 0, 122, 51 ); //thorn 2

// the pink demon
set_color_profile_slot( 5, 0, 255, 135, 221 ); //BODY
set_color_profile_slot( 5, 1, 186, 54, 61 ); //RING
set_color_profile_slot( 5, 2, 212, 23, 52 ); //PLANT GANG
set_color_profile_slot( 5, 3, 97, 0, 46 ); //THORN
set_color_profile_slot( 5, 4, 214, 211, 197 ); //WING/EYE (1)
set_color_profile_slot( 5, 5, 171, 164, 145 ); //WING/EYE (2)
set_color_profile_slot( 5, 6, 219, 35, 201 ); //2nd body
set_color_profile_slot( 5, 7, 138, 0, 46 ); //thorn 2

// failed artist
set_color_profile_slot( 6, 0, 134, 217, 100 ); //BODY
set_color_profile_slot( 6, 1, 201, 42, 32 ); //RING
set_color_profile_slot( 6, 2, 150, 176, 125 ); //PLANT GANG
set_color_profile_slot( 6, 3, 92, 97, 153 ); //THORN
set_color_profile_slot( 6, 4, 237, 213, 133 ); //WING/EYE (1)
set_color_profile_slot( 6, 5, 219, 168, 79 ); //WING/EYE (2)
set_color_profile_slot( 6, 6, 104, 189, 96 ); //2nd body
set_color_profile_slot( 6, 7, 110, 95, 76 ); //thorn 2

// cowardly goon
set_color_profile_slot( 7, 0, 227, 125, 23 ); //BODY
set_color_profile_slot( 7, 1, 35, 64, 212 ); //RING
set_color_profile_slot( 7, 2, 166, 99, 27 ); //PLANT GANG
set_color_profile_slot( 7, 3, 118, 156, 151 ); //THORN
set_color_profile_slot( 7, 4, 237, 203, 133 ); //WING/EYE (1)
set_color_profile_slot( 7, 5, 222, 170, 0 ); //WING/EYE (2)
set_color_profile_slot( 7, 6, 201, 64, 0 ); //2nd body
set_color_profile_slot( 7, 7, 125, 20, 6 ); //thorn 2

// gluttonous prick
set_color_profile_slot( 8, 0, 24, 83, 222 ); //BODY
set_color_profile_slot( 8, 1, 219, 13, 13 ); //RING
set_color_profile_slot( 8, 2, 224, 48, 31 ); //PLANT GANG
set_color_profile_slot( 8, 3, 158, 76, 0 ); //THORN
set_color_profile_slot( 8, 4, 230, 217, 99 ); //WING/EYE (1)
set_color_profile_slot( 8, 5, 212, 151, 20 ); //WING/EYE (2)
set_color_profile_slot( 8, 6, 46, 0, 199 ); //2nd body
set_color_profile_slot( 8, 7, 163, 20, 24 ); //thorn 2

// incompetent warrior
set_color_profile_slot( 9, 0, 80, 65, 176 ); //BODY
set_color_profile_slot( 9, 1, 111, 0, 158 ); //RING
set_color_profile_slot( 9, 2, 247, 218, 0 ); //PLANT GANG
set_color_profile_slot( 9, 3, 176, 126, 0 ); //THORN
set_color_profile_slot( 9, 4, 117, 150, 149 ); //WING/EYE (1)
set_color_profile_slot( 9, 5, 86, 90, 115 ); //WING/EYE (2)
set_color_profile_slot( 9, 6, 79, 13, 135 ); //2nd body
set_color_profile_slot( 9, 7, 133, 77, 0 ); //thorn 2

// general matter
set_color_profile_slot( 10, 0, 30, 11, 61 ); //BODY
set_color_profile_slot( 10, 1, 136, 104, 166 ); //RING
set_color_profile_slot( 10, 2, 86, 83, 99 ); //PLANT GANG
set_color_profile_slot( 10, 3, 33, 16, 61 ); //THORN
set_color_profile_slot( 10, 4, 240, 185, 130 ); //WING/EYE (1)
set_color_profile_slot( 10, 5, 237, 128, 26 ); //WING/EYE (2)
set_color_profile_slot( 10, 6, 0, 0, 0 ); //2nd body
set_color_profile_slot( 10, 7, 47, 46, 48 ); //thorn 2

// nightmare from the dark
set_color_profile_slot( 11, 0, 140, 160, 209 ); //BODY
set_color_profile_slot( 11, 1, 204, 169, 29 ); //RING
set_color_profile_slot( 11, 2, 99, 8, 0 ); //PLANT GANG
set_color_profile_slot( 11, 3, 194, 148, 21 ); //THORN
set_color_profile_slot( 11, 4, 102, 0, 133 ); //WING/EYE (1)
set_color_profile_slot( 11, 5, 27, 0, 92 ); //WING/EYE (2)
set_color_profile_slot( 11, 6, 79, 88, 156 ); //2nd body
set_color_profile_slot( 11, 7, 23, 9, 9 ); //thorn 2

// souless liar
set_color_profile_slot( 12, 0, 221, 153, 232 ); //BODY
set_color_profile_slot( 12, 1, 194, 31, 115 ); //RING
set_color_profile_slot( 12, 2, 128, 98, 14 ); //PLANT GANG
set_color_profile_slot( 12, 3, 163, 24, 28 ); //THORN
set_color_profile_slot( 12, 4, 245, 214, 37 ); //WING/EYE (1)
set_color_profile_slot( 12, 5, 222, 130, 36 ); //WING/EYE (2)
set_color_profile_slot( 12, 6, 169, 88, 191 ); //2nd body
set_color_profile_slot( 12, 7, 79, 37, 28 ); //thorn 2

// general dark mind
set_color_profile_slot( 13, 0, 189, 184, 153 ); //BODY
set_color_profile_slot( 13, 1, 227, 195, 34 ); //RING
set_color_profile_slot( 13, 2, 131, 168, 168 ); //PLANT GANG
set_color_profile_slot( 13, 3, 227, 195, 34 ); //THORN
set_color_profile_slot( 13, 4, 141, 92, 201 ); //WING/EYE (1)
set_color_profile_slot( 13, 5, 91, 52, 163 ); //WING/EYE (2)
set_color_profile_slot( 13, 6, 143, 132, 120 ); //2nd body
set_color_profile_slot( 13, 7, 99, 110, 125 ); //thorn 2

// souless paintress
set_color_profile_slot( 14, 0, 190, 116, 227 ); //BODY
set_color_profile_slot( 14, 1, 222, 95, 188 ); //RING
set_color_profile_slot( 14, 2, 88, 205, 209 ); //PLANT GANG
set_color_profile_slot( 14, 3, 209, 206, 65 ); //THORN
set_color_profile_slot( 14, 4, 140, 42, 224 ); //WING/EYE (1)
set_color_profile_slot( 14, 5, 107, 22, 181 ); //WING/EYE (2)
