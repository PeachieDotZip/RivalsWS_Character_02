...
// Physical size
char_height         = 99999;       // original is 60, it has been changed to 99999 for trailer purposes
...
dash_stop_percent   = 0.66;		// 0.25 -  0.5
...
starhit =  hit_fx_create( sprite_get( "star_explosion" ), 17);
sprite_change_offset("star_explosion", 25, 25);

cactushit =  hit_fx_create( sprite_get( "cactus_hfx" ), 17);
sprite_change_offset("cactus_hfx", 25, 25);

halohit =  hit_fx_create( sprite_get( "halo_hfx" ), 19);
...
magolorhit =  hit_fx_create( sprite_get( "magolor_hfx" ), 25);
sprite_change_offset("magolor_hfx", 25, 25);
magolortipperhit =  hit_fx_create( sprite_get( "magolor_tipper_hfx" ), 31);
sprite_change_offset("magolor_tipper_hfx", 25, 25);

bloodhit =  hit_fx_create( sprite_get( "blood_hfx" ), 17);
