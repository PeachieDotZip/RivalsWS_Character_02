...
if (attack == AT_DAIR) {
    var thorn = spawn_hit_fx( hit_player_obj.x - 20 * spr_dir, hit_player_obj.y - 45, cactushit );
    thorn.depth = -10;
}
if (attack == AT_UAIR) && (my_hitboxID.hbox_num == 8 || my_hitboxID.hbox_num == 9 || my_hitboxID.hbox_num == 10) {
    var blud = spawn_hit_fx( hit_player_obj.x - 20 * spr_dir, hit_player_obj.y - 50, bloodhit );
    blud.depth = -10;
}
