...
set_hitbox_value(AT_FTILT, 4, HG_HITSTUN_MULTIPLIER, 1.1);
...
set_hitbox_value(AT_FTILT, 3, HG_LIFETIME, 100);
...
set_hitbox_value(AT_FTILT, 3, HG_PROJECTILE_HSPEED, 7.7);
...
set_hitbox_value(AT_FTILT, 2, HG_KNOCKBACK_SCALING, 0.05);
...
set_hitbox_value(AT_FTILT, 2, HG_PROJECTILE_HSPEED, 7.7);
...
set_hitbox_value(AT_FTILT, 1, HG_PROJECTILE_HSPEED, 7.7);
