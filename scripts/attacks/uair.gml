...
set_hitbox_value(AT_UAIR, 7, HG_BASE_HITPAUSE, 5.5);
set_hitbox_value(AT_UAIR, 7, HG_HITPAUSE_SCALING, .05);
set_hitbox_value(AT_UAIR, 7, HG_SDI_MULTIPLIER, .6);
...
set_hitbox_value(AT_UAIR, 8, HG_VISUAL_EFFECT_Y_OFFSET, -10);
...
set_hitbox_value(AT_UAIR, 9, HG_VISUAL_EFFECT_Y_OFFSET, -10);
...
set_hitbox_value(AT_UAIR, 10, HG_VISUAL_EFFECT_Y_OFFSET, -9);
