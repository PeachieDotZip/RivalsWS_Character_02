...
set_window_value(AT_DAIR, 1, AG_WINDOW_LENGTH, 28);
...
set_hitbox_value(AT_DAIR, 1, HG_MUNO_HITBOX_NAME, "Swipe 1");
...
set_hitbox_value(AT_DAIR, 4, HG_MUNO_HITBOX_NAME, "Swipe 1 (Sour Spot)");
...
set_hitbox_value(AT_DAIR, 2, HG_MUNO_HITBOX_NAME, "Swipe 2");
...
set_hitbox_value(AT_DAIR, 5, HG_MUNO_HITBOX_NAME, "Swipe 2 (Sour Spot)");
...
set_hitbox_value(AT_DAIR, 3, HG_MUNO_HITBOX_NAME, "Swipe 3");
...
set_hitbox_value(AT_DAIR, 6, HG_MUNO_HITBOX_NAME, "Swipe 3 (Sour Spot)");
...
set_hitbox_value(AT_DAIR, 6, HG_BASE_HITPAUSE, 6.1);
