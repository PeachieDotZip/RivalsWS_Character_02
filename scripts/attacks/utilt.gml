...
set_hitbox_value(AT_UTILT, 2, HG_PROJECTILE_ANIM_SPEED, .120);
set_hitbox_value(AT_UTILT, 2, HG_PROJECTILE_VSPEED, -3);
set_hitbox_value(AT_UTILT, 2, HG_PROJECTILE_GRAVITY, 0);
set_hitbox_value(AT_UTILT, 2, HG_PROJECTILE_WALL_BEHAVIOR, 1);
set_hitbox_value(AT_UTILT, 2, HG_PROJECTILE_IS_TRANSCENDENT, false);
